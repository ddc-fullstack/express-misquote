        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = (_a.sent()).data;
                        createPosts = function (array) {
                            //instead of putting the posts into an array insert them into the database.
                            var posts = [];
                            for (var _i = 0, array_1 = array; _i < array_1.length; _i++) {
                                var currentPost = array_1[_i];
                                var post = { postId: null, postUserId: currentPost.userId, postContent: currentPost.body, postTitle: currentPost.title };
                                posts.push(post);
                            }
                            return posts;
                        };
